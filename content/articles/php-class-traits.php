...
author_name: Ryan
excerpt: Although PHP allows classes to implement more than one interface, it does not support multiple inheritance. Unfortunately, lack of support for multiple inheritance can lead to code duplication in certain situations; this is contrary to the goals of reusable object-oriented programming. In this article, I'll explore a couple of these situations and talk about a new language-level feature in PHP 5.4 that has been added to address this concern: traits.
---
